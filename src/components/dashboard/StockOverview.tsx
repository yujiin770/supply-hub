        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col h-full">
            ...
            <div className="grid grid-cols-3 gap-4 sm:gap-8 flex-1 content-end pb-4">
                <div className="flex flex-col items-center">
                    ...
                    <div className={`w-full h-32 rounded-xl ${hasStock > 0 ? 'bg-green-500' : 'bg-gray-100'}`}></div>
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className={`w-full h-32 rounded-xl ${noStock > 0 ? 'bg-red-600 mb' : 'bg-gray-100'}`}></div>
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className={`w-full h-32 rounded-xl ${disabled > 0 ? 'bg-gray-400' : 'bg-gray-100'}`}></div>
