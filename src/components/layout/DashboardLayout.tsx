...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children, onExit, onNavigate }) => {
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden transition-all duration-300 relative w-full">
        ...
        <div className="bg-amber-400 border-b border-amber-200 px-4 sm:px-6 py-2.5 shrink-0">
          ...
          <div className="sm:hidden flex items-center justify-between">
            ...
            <button onClick={onExit} className="bg-white text-amber-600 px-2 py-1 rounded-md text-[10px] font-bold flex items-center gap-1">
              <X className="w-3 h-3" />
              <span>Exit</span>
            </button>
          </div>
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-3 pl-4 border-l border-gray-200">
              <div className="text-right hidden sm:block">
                ...
                <div className="text-xs text-gray-500 font-medium">Supplier Admin</div>
              </div>
